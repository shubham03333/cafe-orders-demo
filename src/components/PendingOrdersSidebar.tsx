  ...
  return (
    <>
      ...
      <div className={`fixed right-0 top-0 h-full w-80 bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${
        ...
        {/* Sidebar Header */}
        <div className="bg-gradient-to-r from-[#6B4423] to-[#8B6239] p-4 flex-shrink-0">
        ...
        <div className="bg-gray-50 p-4 border-b border-gray-200 flex-shrink-0">
          <div className="relative">
            <button
              ...
              className="px-3 py-2 border border-gray-400 rounded-lg text-sm bg-white text-black focus:ring-2 focus:ring-[#D4A574] focus:border-transparent w-full text-left flex items-center justify-between min-h-[40px] shadow-sm hover:border-gray-500 transition-colors"
            >
          ...
          {orders.length === 0 ? (
            ...
            <div className="space-y-3 pr-1">
              {orders
                ...
                <div
                  key={order.id}
                  className="p-3 sm:p-4 md:p-5 rounded-lg border-l-4 border-[#E67E22] bg-gradient-to-r from-[#FFF8F0] to-white shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer"
                ...
                >
                  <div className="flex flex-row justify-between items-center gap-2 mb-2">
                    ...
                    <div className="text-right flex-shrink-0">
                      <div className="font-bold text-sm sm:text-base md:text-lg text-[#E67E22] whitespace-nowrap">₹{order.total}</div>
                    </div>
                  </div>

                  <div className="mb-2 sm:mb-3 md:mb-4">
                    {order.items.map(item => (
                      <div key={item.id} className="flex justify-between items-center text-xs sm:text-sm text-gray-900 py-1 sm:py-2 border-b border-[#E8DFD4] last:border-b-0">
                        ...
                        <button
                          ...
                          className="p-1 sm:p-1.5 md:p-2 text-[#6B4423] hover:text-[#8B6239] hover:bg-[#FFF8F0] rounded-full transition-colors"
                          title="Remove item"
                        >
                  ...
                  <div className="flex flex-row gap-1">
                    <button
                      ...
                      className="px-2 py-1 bg-[#6B4423] hover:bg-[#8B6239] text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-1 text-xs"
                      title="Edit order"
                    >
